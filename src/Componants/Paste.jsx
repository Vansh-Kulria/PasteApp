...
const Paste = () => {
  ...
  return (
      <div className="min-h-[calc(100vh-72px)] bg-gradient-to-br from-blue-100 via-blue-200 to-blue-300 py-6 ">
        <div className=" mx-6 ">
            <div className={`mx-6  ${showDeleteAllConfirm || showDeleteConfirm ? 'blur-sm' : ''}`}>
          ...
          <div className=' border-1 p-2 rounded-b-3xl border-blue-300 '>
            ...
            <div className="flex flex-col gap-3 ">
              {filteredData.length > 0 ? (
                filteredData.map((paste) => (
                  <div
                    key={paste._id}
                    className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-blue-200 p-6 transition-transform hover:scale-[1.009]"
                  >
            ...
            <div>
              {showDeleteConfirm && selectedPasteId &&(

                <div className="fixed inset-0 flex items-center justify-center  bg-opacity-40 z-150">
